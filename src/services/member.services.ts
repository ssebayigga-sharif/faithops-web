...
// Extend Member to carry the Firebase push key without polluting the public type
declare module "../churchTypes/memberTypes" {
  interface Member {
    // Firebase auto-generated push key. Populated after fetch, never stored
    //  in the UI state unless you need it for mutations. */
    _firebaseKey?: string;
  }
}
