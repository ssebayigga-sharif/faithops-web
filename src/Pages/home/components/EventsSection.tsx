...
import { UPCOMING_EVENTS } from "../church";
import { useFadeIn } from "../useFadeIn";
import EventCard from "./EventCard";
import type { ChurchEvent } from "../index";
...
const EventsSection: React.FC = () => {
  ...
  const filtered = activeCategory === ALL_LABEL
    ? UPCOMING_EVENTS
    : UPCOMING_EVENTS.filter((e: ChurchEvent) => e.category === activeCategory);
    ...
    >
      <Grid>
        ...
        {filtered.length === 0 ? (
          ...
          filtered.map((ev: ChurchEvent, i: number) => (
